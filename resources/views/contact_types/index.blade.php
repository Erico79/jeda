...
@section('sparks')
    <a href="#dt_basic" data-toggle="modal" data-target="#remoteModal" class="btn btn-success btn-lg pull-right header-btn hidden-mobile">
...
{{-- show success message if any--}}
    ...
    <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
        ...
        <tr>
            ...
            <td>{{ $contact->contact_type_status }}</td>
        </tr>
            @endforeach
        </tbody>
    </table>
